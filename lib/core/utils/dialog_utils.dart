...
import 'package:resto_rw/ui/screens/widgets/dialog/info_dialog.dart';
import 'package:resto_rw/ui/screens/widgets/dialog/loading_dialog.dart';
  ...
  void showLoading(BuildContext context, String message) {
    showModal(
        ...
        configuration:
            FadeScaleTransitionConfiguration(barrierDismissible: false),
        builder: (context) {
          return LoadingDialog(text: message);
        });
  }
}
